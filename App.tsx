...
import { TaurusIcon, StarIcon, SnowflakeIcon, FilterIcon, GasPumpIcon, WifiIcon, FoodIcon, PiggyBankIcon, TargetIcon, ChartLineIcon, WarningIcon, PlusIcon, CheckIcon, CalendarIcon, TagIcon, MoneyBillIcon, BoltIcon, SaveIcon, CircleIcon, CheckCircleIcon, HistoryIcon, HourglassIcon, CloseIcon, ListIcon, TrashIcon, CreditCardIcon, RepeatIcon, EditIcon, ReceiptIcon, ShoppingBagIcon, MinusIcon, CalendarPlusIcon, PlaneIcon, WalletIcon, SunIcon, ArrowRightIcon, ExchangeIcon, GearIcon, CloudArrowUpIcon, CloudArrowDownIcon, FileCodeIcon, FlowerIcon, LeafIcon, UmbrellaIcon, HeartIcon, BrainIcon, ShieldIcon, RocketIcon, FeatherIcon, TreeIllustration, DeskIllustration, PushPinIcon, EnvelopeIcon } from './components/icons';
